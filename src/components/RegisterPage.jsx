...
const RegisterPage = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center lg:text-left">
      ...
      <p className="py-6">Join us in celebrating the beauty of handmade Wooden Home decor and jute decor! Create an account to access exclusive offers and updates.</p>
    </div>
